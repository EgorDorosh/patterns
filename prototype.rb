# Prototype is a creational design pattern that allows object to be copied without going into the details of their
# implementations.
#
# Use this pattern when your code shouldn't depend on the concrete classes of object that you need to copy,
# or when you want to reduce the number of subclasses that only differ in the way they initialize their respective
# objects. Somebody could have created these subclasses to be able to create objects with a specific configuration.
#
# Be attentive when you are copying object with circular references.
class Prototype
